...
public class G10IndexRIDRangeIterator implements IndexResultIterator<RID> {
	...
	public G10IndexRIDRangeIterator(BufferPoolManager bufferPool, IndexSchema schema,  int resourceId, BTreeLeafPage firstPage,
