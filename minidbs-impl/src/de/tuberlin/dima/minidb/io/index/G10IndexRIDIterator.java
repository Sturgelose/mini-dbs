...
public class G10IndexRIDIterator implements IndexResultIterator<RID> {
	...
	public G10IndexRIDIterator(BufferPoolManager bufferPool, IndexSchema schema,  int resourceId, BTreeLeafPage firstPage, DataField key) {
