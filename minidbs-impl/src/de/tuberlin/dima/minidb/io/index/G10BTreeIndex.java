...
public class G10BTreeIndex implements BTreeIndex{
	...
	public G10BTreeIndex(IndexSchema schema, BufferPoolManager bufferPool, int resourceId) {
	...
	throws PageFormatException, IndexFormatCorruptException, IOException {
		...
		return new G10IndexRIDIterator(bufferPool, schema, resourceId, leaf, key);
	...
	throws PageFormatException, IndexFormatCorruptException, IOException {
		...
		return new G10IndexRIDRangeIterator(bufferPool, schema, resourceId, leaf, startKey, stopKey, startKeyIncluded, stopKeyIncluded);
	...
	throws PageFormatException, IndexFormatCorruptException, IOException {
		...
		return new G10IndexKeyIterator(bufferPool, schema, resourceId, leaf, startKey, stopKey, startKeyIncluded, stopKeyIncluded);
	}
