...
public class G10IndexKeyIterator implements IndexResultIterator<DataField> {
	...
	public G10IndexKeyIterator(BufferPoolManager bufferPool, IndexSchema schema,  int resourceId, BTreeLeafPage firstPage,
