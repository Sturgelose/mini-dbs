...
public class G10HadoopTableScanOperator extends HadoopOperator<Text, DataTuple> {
	
	
	private final static String CONF_PREDICATE = "de.tuberlin.dima.minidb.mapred.qexec.G10HadoopTableScanOperator.Predicate";
	...
	public G10HadoopTableScanOperator(DBInstance instance,
