...
public class G10HadoopGroupByOperator extends HadoopOperator<DataTuple, DataTuple> {
	
	private final static String CONF_GROUP_COLS= "de.tuberlin.dima.minidb.mapred.qexec.G10HadoopGroupByOperator.groupCols";
	private final static String CONF_GROUP_OUT_COLS= "de.tuberlin.dima.minidb.mapred.qexec.G10HadoopGroupByOperator.groupOutCols";
	
	private final static String CONF_AGG_COLS= "de.tuberlin.dima.minidb.mapred.qexec.G10HadoopGroupByOperator.aggCols";
	private final static String CONF_AGG_TYPES = "de.tuberlin.dima.minidb.mapred.qexec.G10HadoopGroupByOperator.aggTypes";
	private final static String CONF_AGG_DATA_TYPES = "de.tuberlin.dima.minidb.mapred.qexec.G10HadoopGroupByOperator.aggDataTypes";
	private final static String CONF_AGG_OUT_COLS = "de.tuberlin.dima.minidb.mapred.qexec.G10HadoopGroupByOperator.aggOutCols";
	...
	public G10HadoopGroupByOperator(DBInstance instance,
