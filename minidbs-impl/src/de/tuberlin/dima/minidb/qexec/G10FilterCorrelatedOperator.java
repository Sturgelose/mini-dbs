...
public class G10FilterCorrelatedOperator implements FilterCorrelatedOperator {

	private PhysicalPlanOperator child;
	private JoinPredicate correlatedPredicate;
	private DataTuple correlatedTuple;

	public G10FilterCorrelatedOperator(PhysicalPlanOperator child, JoinPredicate correlatedPredicate) {
