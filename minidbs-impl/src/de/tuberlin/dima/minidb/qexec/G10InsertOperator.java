...
public class G10InsertOperator implements InsertOperator {
	...
	public G10InsertOperator(BufferPoolManager bufferPool, TableResourceManager tableManager, int resourceId,
