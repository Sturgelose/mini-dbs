...
public class G10IndexLookupOperator implements IndexLookupOperator {
	...
	public G10IndexLookupOperator(BTreeIndex index, DataField equalityLiteral) {
		
		this.index = index;
		this.equalityLiteral = equalityLiteral;
	}

	public G10IndexLookupOperator(BTreeIndex index, DataField lowerBound, boolean lowerIncluded,
