...
public class G10SortOperator implements SortOperator {
	...
	public G10SortOperator(PhysicalPlanOperator child, QueryHeap queryHeap,	DataType[] columnTypes, int estimatedCardinality,
