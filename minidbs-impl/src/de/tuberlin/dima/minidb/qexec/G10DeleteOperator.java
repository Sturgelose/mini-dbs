...
public class G10DeleteOperator implements DeleteOperator {

	private BufferPoolManager bufferPool;
	private int resourceId;
	private PhysicalPlanOperator child;

	public G10DeleteOperator(BufferPoolManager bufferPool, int resourceId, PhysicalPlanOperator child) {
